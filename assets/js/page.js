...
let pageSocket = new Socket("/socket", { params: { token: window.userToken } })
...
let channel = pageSocket.channel("room:lobby", {})
...
let channelTest = pageSocket.channel("room:test", {})
...
let productOrderChannel = pageSocket.channel("room:product-order", {})
